/**
 * env 下个的3个Js文件 为根据环境处理不用的配置依赖
 * 需要安装相应的合并插件 npm install --save-dev wabpack-merge
 * 配置完后，启动要需要配置package.json里面的 scripts配置内容
 * 如：
 * "build": "webpack --config ./ pro.config",
    "dev": "webpack-dev-server --open --config ./dev.config.js"
 */
